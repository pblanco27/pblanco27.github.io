...
//Definiciones globales de datos:
...
window.onload = function() {
	...
	annohoy = hoy.getFullYear(); //aÒo actual
...
//FUNCIONES de creaciÛn del calendario:
...
//primera lÌnea de tabla: dÌas de la semana.
...
function mifecha() {
	...
	if (isNaN(mianno) || mianno<1) { 
		//aÒo mal escrito: mensaje de error
		alert("El aÒo no es v·lido:\n debe ser un n˙mero mayor que 0")
	}
